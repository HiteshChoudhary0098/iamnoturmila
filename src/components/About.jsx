        ...
        <div className="grid">
          ...
          <div className="about-copy">
            ...
            <p className="bio reveal d4">
              ...
              <b>comunicadora estratégica</b> apasionada por el contenido digital, branding y la
              fotografía. Autodidacta, detallista y ordenada. Amo crear y en el proceso conectar con
              las marcas y las personas.
            </p>
            <div className="socials reveal d5">
              <a className="ic" href="#" title="LinkedIn">in</a>
              <a className="ic" href="#" title="Behance">Bē</a>
              <a className="ic" href="#" title="Instagram">◎</a>
